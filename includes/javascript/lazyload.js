...
class cwvLazyLoadScripts {
    ...
    _addUserInteractionListener(e) {
        console.log('_addUserInteractionListener called');
        this.triggerEvents.forEach((t => window.addEventListener(t, e.userEventListener, e.eventOptions)))
    }
    _removeUserInteractionListener(e) {
        console.log('_removeUserInteractionListener called');
        this.triggerEvents.forEach((t => window.removeEventListener(t, e.userEventListener, e.eventOptions)))
    }
    triggerListener() {
        console.log('triggerListener called');
        this._removeUserInteractionListener(this), "loading" === document.readyState ? document.addEventListener("DOMContentLoaded", this._loadEverythingNow.bind(this)) : this._loadEverythingNow()
    }
    async _loadEverythingNow() {
        console.log('_loadEverythingNow called');
        this._delayEventListeners(), this._delayJQueryReady(this), this._handleDocumentWrite(), this._registerAllDelayedScripts(), this._preloadAllScripts(), await this._triggerDOMContentLoaded(), await this._triggerWindowLoad(), window.dispatchEvent(new Event("cwv-allScriptsLoaded"))
    }
    _registerAllDelayedScripts() {
        console.log('_registerAllDelayedScripts called');
    ...
    async _transformScript(e) {
        console.log('_transformScript called');
    ...
    _preloadAllScripts() {
        console.log('_preloadAllScripts called');
    ...
    _delayEventListeners() {
        console.log('_delayEventListeners called');
        let e = {};
    ...
    _delayJQueryReady(e) {
        console.log('_delayJQueryReady called');
        let t = window.jQuery;
    ...
    async _triggerDOMContentLoaded() {
        console.log('_triggerDOMContentLoaded called');
    ...
    async _triggerWindowLoad() {
        console.log('_triggerWindowLoad called');
    ...
    _handleDocumentWrite() {
        console.log('_handleDocumentWrite called');
        const e = new Map;
    ...
    static run() {
        console.log('static run called');
        const e = new cwvLazyLoadScripts(["keydown","mouseover","mousemove", "touchmove", "touchstart", "touchend", "wheel"]);
